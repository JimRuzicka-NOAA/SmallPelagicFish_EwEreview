function [ECOTRAN] = ECOTRANheart_05132022(EwEResult, MonteCarloStore)
...
%
% calls:
%       f_ECOfunction_05132022                      returns a single ECOTRAN model for 1 "type" EwE model or 1 MonteCarlo EwE model
